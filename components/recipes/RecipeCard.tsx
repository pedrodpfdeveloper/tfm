            ...
            {isAdmin && (
                <div className="p-4 pt-0 flex items-center gap-2 mt-auto">
                    <Link
                        ...
                        title="Editar"
                        className="inline-flex items-center gap-2 px-3 py-1.5 text-sm rounded-md border bg-[var(--button-bg,white)] text-[var(--button-text,#111)] hover:bg-[var(--gray-50)]"
                    >
                    ...
                    <button
                        ...
                        title="Eliminar"
                        className="ml-auto inline-flex items-center gap-2 px-3 py-1.5 text-sm rounded-md border text-white bg-red-600 hover:opacity-90"
                    >
                            ...
                            >
                                ...
                                <div className="flex gap-2 justify-end">
                                    <button
                                        ...
                                        className="px-3 py-1.5 text-sm rounded-md border bg-[var(--button-bg,white)] text-[var(--button-text,#111)] hover:bg-[var(--gray-50)] dark:bg-gray-800 dark:text-white"
                                    >
                                        Cancelar
                                    </button>
                                    <form action={deleteRecipe}>
                                        ...
                                        <button
                                            type="submit"
                                            className="inline-flex items-center gap-2 px-3 py-1.5 text-sm rounded-md bg-red-600 text-white hover:opacity-90"
                                        >
                                            <svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"/></svg>
                                            <span>Eliminar</span>
                                        </button>
